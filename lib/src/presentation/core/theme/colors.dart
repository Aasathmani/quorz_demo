...
class AppColors {
  ...
  static const Color mercuryAlpha = Color(0xFF7E7E7E);
  ...
  static const Color orangeLight = Color(0xFFFF7304);
  static const Color pingLight = Color(0xFFFB2A77);
  static const Color redCon = Color(0xFFFE4545);
  static const Color lightBlueCon = Color(0xFFF5F6FB);
  static const Color orangeCon = Color(0xFFFE9C13);
  static const Color orangeBen = Color(0xFFFB9428);
  static const Color orangeDark = Color(0xFFE34E2F);
  static const Color orangePink = Color(0xFFE23851);
  static const Color redOrange = Color(0xFFFE4545);
  static const Color lightBlueMoon = Color(0xFFF5F6FB);
  static const Color orangeMenDark = Color(0xFFFE4545);
  static const Color mildWhite = Color(0xFFF5F6FB);
}

class GradientColors {
  GradientColors._();

  static List<Color> get appBarGradient => [
        AppColors.orangeLight,
        AppColors.pingLight,
      ];

  static List<Color> get highValue => [
        AppColors.orangeCon,
        AppColors.orangeBen,
      ];
  static List<Color> get expiringSoon => [
