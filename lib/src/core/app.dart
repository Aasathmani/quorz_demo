...
import 'package:app_qoruz/firebase_options.dart';
...
import 'package:app_qoruz/src/core/routes.dart';
...
import 'package:app_qoruz/src/presentation/widgets/app_version_widget.dart';
import 'package:app_qoruz/src/utils/deeplink_handler.dart';
...
import 'package:app_qoruz/src/utils/notifications_handler.dart';
  ...
  runZonedGuarded<Future<void>>(
    () async {
      ...
      runApp(MultiBlocProvider(
        providers: [
          BlocProvider(create: (_) => provideBottomNavigationBloc()),
        ],
        child: App(),
      ));
    },
