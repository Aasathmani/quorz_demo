...
class S {
  ...
  /// `FES Project`
  String get labelFESProject {
    return Intl.message(
      'FES Project',
      name: 'labelFESProject',
      desc: '',
      args: [],
    );
  }
  ...
  String get msgEmailNotValid {
    return Intl.message(
      'Email address not valid or empty',
      name: 'msgEmailNotValid',
      desc: '',
      args: [],
    );
  }

  /// `Mobile number not valid or empty`
  String get msgMobileNumberNotValid {
    return Intl.message(
      'Mobile number not valid or empty',
      name: 'msgMobileNumberNotValid',
      desc: '',
      args: [],
    );
  }
  ...
  String get msgPasswordValid {
    return Intl.message(
      'Please enter the password',
      name: 'msgPasswordValid',
      desc: '',
      args: [],
    );
  }
  ...
  String get msgPleaseEnterFirstName {
    return Intl.message(
      'Please enter first name',
      name: 'msgPleaseEnterFirstName',
      desc: '',
      args: [],
    );
  }
  ...
  String get msgPleaseEnterLastName {
    return Intl.message(
      'Please enter last name',
      name: 'msgPleaseEnterLastName',
      desc: '',
      args: [],
    );
  }
  ...
  String get labelEnterPinNumber {
    return Intl.message(
      'Enter the pin number',
      name: 'labelEnterPinNumber',
      desc: '',
      args: [],
    );
  }
